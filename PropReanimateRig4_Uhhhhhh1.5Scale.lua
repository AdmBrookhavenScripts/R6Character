...
local Founded = {}
local Scale = 1.5 / 2.5
local Offset = 1.25 * Scale

local DownAngle = CFrame.new(0, -Offset, 0)

local Offsets = {
    [1] = {"Torso", CFrame.new(-Offset,  Offset, 0)},
    [2] = {"Torso", CFrame.new( Offset,  Offset, 0)},
    [3] = {"Torso", CFrame.new(-Offset, -Offset, 0)},
    [4] = {"Torso", CFrame.new( Offset, -Offset, 0)},

    [5] = {"Right Arm", CFrame.new(0,  Offset, 0)},
    [6] = {"Right Arm", CFrame.new(0, -Offset, 0)},

    [7] = {"Left Arm", CFrame.new(0,  Offset, 0)},
    [8] = {"Left Arm", CFrame.new(0, -Offset, 0)},

    [9] = {"Left Leg", CFrame.new(0,  Offset, 0)},
    [10] = {"Left Leg", CFrame.new(0, -Offset, 0)},

    [11] = {"Right Leg", CFrame.new(0,  Offset, 0)},
    [12] = {"Right Leg", CFrame.new(0, -Offset, 0)},

    [13] = {"Head", CFrame.new()},
    [14] = {"Head", CFrame.new(0, 0, -1.2 * Scale) * CFrame.Angles(0, math.rad(180), 0)}
}

local Player = Players.LocalPlayer
local Character = workspace["(C) Uhhhhhh V1.0.9 BETA"]
