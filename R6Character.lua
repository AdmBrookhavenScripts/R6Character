...
local newChar = Players:CreateHumanoidModelFromDescription(
	desc,
...
local hrpNew = newChar:FindFirstChild("HumanoidRootPart")
local hrpOld = char:FindFirstChild("HumanoidRootPart")
if hrpNew then
	newChar.PrimaryPart = hrpNew
end
if hrpNew and hrpOld then
	newChar:SetPrimaryPartCFrame(hrpOld.CFrame)
end

if not char then return end

oldHrp = char:FindFirstChild("HumanoidRootPart")
if oldHrp then
	Tp = true
end
